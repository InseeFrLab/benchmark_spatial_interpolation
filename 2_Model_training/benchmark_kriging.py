...
Usage:
    uv run python 2_Model_training/benchmark_kriging.py
...
MODELS = [
    ...
    {
        "name": "kriging_spherical_nlags10",
        "class": PyKrigeWrapper,
        "number_axis": 23,
        "params": {
            "variogram_model": "spherical",
    ...
    {
        "name": "kriging_spherical_nlags15",
        "class": PyKrigeWrapper,
        "number_axis": 23,
        "params": {
            "variogram_model": "spherical",
    ...
    {
        "name": "kriging_spherical_weighted",
        "class": PyKrigeWrapper,
        "number_axis": 23,
        "params": {
            "variogram_model": "spherical",
...
def run_model(model_config: dict, X_train, X_test, y_train, y_test) -> dict:
    ...
    # Special handling for GeoRF
    is_georf = model_config["name"] == "geoRF"
    ...
    if is_georf:
        pipeline.fit(X_train, y_train, ml_model__gens="da")  # Specifica il generatore
    else:
