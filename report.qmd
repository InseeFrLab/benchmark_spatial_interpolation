...
| **rgealti** | Real | Large | Grid | 100,000* |  RGEALTI. |
...
** Note: For the full RGEALTI, the script currently uses a `.head(100_000)` limit to manage the massive 22-billion-row source file.*
